...
public:
    ...
    mathParser2 *math;
    int Tag;
    DynamicWindow(QWidget *parent = nullptr, TableProperty_fr_xml *Table_Decl = nullptr, dma *DMA = nullptr, mathParser2 *math = nullptr, QObjectList *list_widget = nullptr): QWidget(parent, Qt::Window)
    {
        this->math = math;
        this->DMA = DMA;
        this->math = math;
